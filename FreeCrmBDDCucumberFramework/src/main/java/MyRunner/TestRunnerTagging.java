...
@CucumberOptions(  
		...
		// Example 2
		features = "C:\\Users\\bodduv\\git\\FreeCrmBDDCucumberFramework\\FreeCrmBDDCucumberFramework\\src\\main\\java\\Features\\tagging.feature", //the path of the feature files
...
//  OR : tags = {"@SmokeTest, @RegressionTest"}  - execute all the test cases  smoke or regression
// AND : tags = {"@SmokeTest", "@RegressionTest"} - execute all the test cases  smoke and  regression
//
